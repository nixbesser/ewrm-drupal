 ...
 * @endcode
 */
$settings['hash_salt'] = '1r94LbzSD4aBYVpz9OzEYs7iqttSaZ67K40z809A_hTY_OnCfmXDKjk4Ge7ZtSL8Z2m7p1WywQ';
...
# $settings['file_public_base_url'] = 'https://media.ewrm.io/sites/default/files';
...
$databases['default']['default'] = array (
  'database' => 'ewrm_cms',
  'username' => 'ewrm_cms_user',
  'password' => 'J/q?Er8Zi#:x@+NR_DB+cms',
  'prefix' => '',
  'host' => 'localhost',
...
$settings['config_sync_directory'] = 'sites/default/files/config_x2_I76ey_HR53OsUwqOo0WWcUkDZFRZNps14QoWg6iwpG4cBPNbZ9rLrONPYmU7M_A1lGFDHyw/sync';
...
/**
 * Iframely
 * Keep secrets in settings.php (NOT in config).
 */
$settings['iframely'] = [
  'api_key' => '978c86f629f0e1fdb41da79caa8ccdba',
  // Optional: if you use self-hosted iframely, set base_url like:
  // 'base_url' => 'https://iframely.yourdomain.com',
  // Otherwise leave null to use the cloud API.
  'base_url' => null,
];
